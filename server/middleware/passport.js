  ...
  return models.Auth.where({ type, oauth_id: oauthProfile.id }).fetch({
    ...
    .catch(() => {
      ...
      // and there is no access to req here
        ...
        'message': 'Signing up requires an email address, please be sure there is an email address associated with your Facebook account and grant access when you register.' })
    })
}
